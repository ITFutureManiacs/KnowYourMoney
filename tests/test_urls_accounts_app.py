...
@pytest.mark.parametrize("url_fragments", ["/accounts/password_reset/",
...
@pytest.mark.parametrize("url_fragments", ['/accounts/login/',
...
@pytest.mark.parametrize("url_fragments", ['/accounts/password_change/',
                                           "/accounts/password_change/done/"
                                           ])
@pytest.mark.django_db
def test_urls_response_code_required_logged(client, user_login, new_user, url_fragments):
    response = client.get(f"{url_fragments}")
