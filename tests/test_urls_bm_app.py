...
def test_urls_response_code_required_logged_expense(client, user_logged_db_populated):
    ...
    response_expense_update = client.get(f'/expense/{user_logged_db_populated["new_expense"].id}/update/')
    response_expense_delete = client.get(f'/expense/{user_logged_db_populated["new_expense"].id}/delete/')
...
@pytest.mark.django_db
def test_urls_response_code_required_logged_home_category_source(client, user_logged_db_populated, url_fragments):
